...
public class AlumnoData {
    ...
    public void guardarAlumno(Alumno alumno){
        String sql = "INSERT INTO alumno(dni, apellido, nombre, fechaNac, activo)"
                + "VALUES(?, ?, ?, ?, ?)";
    ...
    public Alumno buscarAlumno(int id){
        String sql = "SELECT dni, apellido, nombre, fechaNac FROM alumno "
            + "WHERE idAlumno = ? AND activo = 1 ";
        Alumno alumno = null;
        try {
